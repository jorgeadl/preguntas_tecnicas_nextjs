export const carreras = [ 
    {
        ...
        "questions":[
            {                  
                    ...
                    "Respuesta": "Mi lenguaje de programación favorito en este momento es Python, porque me permite implementar múltiples funcionalidades usando menos código. El ecosistema que ofrece Python es bastante cómodo para trabajar, ya que ofrece buenas bibliotecas para un sinfín de cosas."
                },
            
            {                  
                    "Pregunta": "2. ¿Cuáles han sido tus responsabilidades anteriores en el puesto como desarrollador full-stack? ",
                    "Respuesta": "En mi puesto anterior, fui responsable de múltiples actividades de codificación clave y que requerían la gestión general del proyecto. Por ejemplo, me encargué de crear el código de prueba que serviría para probar, monitorear y asegurar el rendimiento de las aplicaciones. Solía reunirme con los clientes para entender en profundidad sus necesidades y adaptarme a su proyecto."
                },
            {                  
                    "Pregunta": "3. ¿Cómo mantienes tus conocimientos actualizados? ",
                    "Respuesta": "Para mí, la educación constante y la actualización de mis conocimientos es un elemento esencial. Por ello, suelo asistir a eventos y seminarios sobre tecnología que presentan nuevos productos, herramientas y extensiones que me servirán para mejorar mi trabajo. En añadido, leo habitualmente blogs y revistas especializadas en programación para descubrir las tendencias relevantes."
                },
            {                  
                    "Pregunta": "4. ¿Qué factores consideras al codificar respecto al SEO?",
                    "Respuesta": "Hay una serie de estándares clave que siempre implemento en mi código. Algunos de ellos son la especificación de una etiqueta alt en cualquier imagen, etiquetas HTML precisas para la jerarquía de los contenidos, SSL habilitado e integración con Google Ads. Esto influye positivamente en el posicionamiento SEO, debido a que permite clasificar de forma orgánica a un sitio web en los motores de búsqueda."
                },
            {                  
        ...
        "questions": [
            {
                "Pregunta": "1. ¿Por qué es importante el diseño de experiencia de usuario (UX)?",
                "Respuesta": "El diseño es importante porque mejora la experiencia del usuario en la plataforma. Además, esto influye directamente en la satisfacción del cliente. Lo cual, ayuda a retener mayor cantidad de usuarios y aumentar las ganancias de la empresa.\n                Una buena respuesta está centrada en los usuarios. El candidato habla de realizar investigaciones, pruebas de usabilidad y diseño del recorrido del cliente para comprender sus necesidades. Se observa empatía y busca conocer lo que desean los usuarios del sitio web y/o aplicación móvil.\n                Por otro lado, una mala respuesta tratará sobre el atractivo visual del sitio. Por ende, el candidato no hablará de que la interfaz debe ser funcional. Por lo cual, no garantizará que la navegación en el sitio sea fluida, ni que la  experiencia en el sitio sea agradable."
            },
            {
                "Pregunta": "2. ¿Qué significa para ti el término ‘design-thinking’?",
                "Respuesta": "El ‘Pensamiento de diseño’ o ‘Design Thinking’  es un enfoque basado en generar soluciones prácticas y creativas. Por lo que, su intención es descubrir información sobre las necesidades insatisfechas de los usuarios. Con ello, se tiene la intención de producir un resultado que beneficie tanto a los usuarios como a la empresa. \n                El candidato dará una buena respuesta si habla de cómo lograr un diseño innovador. Debe considerar como solucionar los diferentes problemas y retos que implican realizar un diseño que pueda mantener contentos a los usuarios. Lo ideal es que su respuesta gire en torno a satisfacer las necesidades de los clientes. \n                Habrá una mala respuesta si el candidato no ofrece soluciones innovadoras. Solo hablará de cómo el diseño le puede generar ganancias a la empresa. Por tanto, la respuesta no estaría centrada en lo que desean los usuarios de la plataforma."
            },
            {
                "Pregunta": "3. ¿Qué métodos utilizas para optimizar la experiencia de usuario?",
                "Respuesta": "Entrevistas. \n                Encuestas presenciales y/o en línea.\n                User persona.\n                Auditoría de contenido. \n                Pruebas de usabilidad. \n                Mapas de calor. "
            },
            {
                "Pregunta": "4. ¿Cuáles son algunos desafíos a los que te enfrentaste como Diseñador UX?",
                "Respuesta": "Desafíos típicos a los que los diseñadores suelen enfrentarse en su día a día son: \n                Justificar el diseño del sitio y/o aplicación ante los stakeholders. \n                Realizar investigación de usuario de forma remota. \n                Recopilación, análisis y traducción de datos del usuario. \n                Hacer pruebas de usabilidad adecuadas durante el proceso de diseño del producto. "
            },
            {
                "Pregunta": "5. ¿Cómo mantienes al día tu conocimiento en Diseño UX?",
                "Respuesta": "Algunas formas en que un Diseñador se mantiene al día con las principales tendencias de UX son: \n                Escuchar podcasts sobre el tema.\n                Ver videos en canales especializados.  \n                Leer blogs y libros de UX. \n                Asistir a seminarios web. \n                Cursos de capacitación / bootcamps."
            },
            {
                "Pregunta": "6. ¿Cuáles consideras que son las tendencias actuales de Diseño UX? ",
                "Respuesta": "Tendencias en las que los diseñadores actualmente se fijan para el desarrollo de sus proyectos son: \n                Plataformas impulsadas con inteligencia artificial. \n                Diseño generativo (diseño basado en el análisis de datos). \n                Personalización avanzada (hacer que el usuario sienta que el contenido se crea específicamente para su persona). \n                Interacciones sin contacto (interfaz de usuario por voz). \n                Experiencias 3D. "
            },
            {
                "Pregunta": "7. ¿Qué elementos consideras para hacer que un sitio web o plataforma sea accesible para todo tipo de usuarios? Considera, especialmente, usuarios con discapacidades visuales, auditivas y motoras.",
                "Respuesta": "Algunos puntos a tomar en cuenta para realizar un diseño inclusivo son los siguientes.\n                Seguir las ‘Pautas de accesibilidad al contenido web’ de World Wide Web Consortium. \n                Diseñar una interfaz que pueda ser utilizada por todos los usuarios.\n                Realizar pruebas de usabilidad con personas con discapacidades sensoriales. \n                Inclusión de comandos de voz para navegar por el sitio. \n                Inclusión de subtítulos en contenido para personas problemas visuales."
            },
            {
                "Pregunta": "8. Aquí está nuestro sitio web. ¿Cómo mejorarías la experiencia de usuario en la plataforma? ",
                "Respuesta": "Aspectos comunes de mejora que puede identificar un Diseñador UX en una plataforma son:\n                Incluir llamados a la acción (CTA) atractivos.\n                Implementar un diseño web adaptable (Responsive Design). \n                Incluir enlaces a redes sociales de la empresa. \n                Optimizar la velocidad del sitio web. \n                Utilizar, cuando sea necesario, imágenes y videos para ilustrar el sitio. "
            },
            {
                "Pregunta": "9. ¿Qué puntos consideras esenciales para lograr un diseño atractivo para el usuario?",
                "Respuesta": "Los elementos que brindan una estructura sólida y funcional a un diseño UX son los siguientes: \n                Investigación de usuarios. \n                Usabilidad del sitio web y/o aplicación móvil. \n                Arquitectura de la información del sitio. \n                Diseño de interfaz de usuario. \n                Diseño de la interacción. \n                Diseño de estrategias UX. \n                "
            },
            {
                "Pregunta": "10. ¿Qué consideras para elegir las características que debe de tener el diseño de un sitio web y/o aplicación móvil?",
                "Respuesta": "Factores externos que los diseñadores consideran para planificar y realizar un diseño UX son: \n                El mercado objetivo de la empresa. \n                Investigar las necesidades de las personas que forman parte del mercado objetivo. \n                Plantear las características que resuelven el problema de dichas personas. \n                "
            }
        ]
    },{
        ...
        "questions": [
            {
                "Pregunta": "1. Mencione cuál es la responsabilidad de un data analyst. ",
                "Respuesta": "Solventar los problemas relacionados con el negocio de clientes y realizar auditorías de los datos.\n                Analizar resultados obtenidos e interpretar datos usando técnicas estadísticas y suministrar informes consecutivamente.\n                Jerarquizar las necesidades del negocio y trabajar en colaboración con las necesidades de gestión e información.\n                Conocer los nuevos procesos o áreas de oportunidades y mejoras, de ser necesario.\n                Identificar, analizar e interpretar patrones en conjuntos con datos complejos.\n                Obtener datos de fuentes primarias o secundarias y sostener bases de datos y sistemas de datos.\n                Filtrar, revisar y limpiar los datos informes del ordenador.\n                Ubicar los indicadores de rendimiento para corregir problemas de código\n                Desarrollar la base de datos a través del desarrollo de un sistema de entrada determinando así el nivel de acceso del usuario."
            },
            {
                "Pregunta": "2. ¿Qué se necesita para convertirse en un data analyst? ",
                "Respuesta": "Poseer conocimientos concretos sobre paquetes de informes como Objects, Business, un lenguaje de programación XML, Javascript, bases de datos SQL, SQLite, etc.\n                Capacidad para recolectar, analizar, organizar, y diseminar grandes datos de forma precisa.\n                Tener conocimientos técnicos en el diseño, modelos, y minería de bases de datos, así como técnicas de segmentación.\n                Conocimiento concretos de paquetes estadísticos como: Excel, SPSS, SAS, etc."
            },
            {
                "Pregunta": "3. Mencione cuáles son los diferentes pasos de un proyecto de análisis. ",
                "Respuesta": "Definir el problema\n                Explorar los datos\n                Preparar los datos\n                Modelar los datos\n                Validar datos\n                Seguimiento"
            },
            {
                "Pregunta": "4. Mencione lo que significa la limpieza de datos.",
                "Respuesta": "La limpieza de datos, trata de ubicar y quitar errores e inconsistencias de los datos con la finalidad de mejorar su calidad."
            },
            {
                "Pregunta": "5. Enumere algunas de las mejores prácticas para la limpieza de datos.",
                "Respuesta": "Colocar los datos por atributos distintos.\n                Cuando son grandes conjuntos de datos, limpiar paso a paso, para lograr una mejor calidad.\n                Cuando el conjunto de datos es grande, divide en grupos más pequeños. Trabajando con menor cantidad de datos, aumenta la velocidad de iteración.\n                Para realizar tareas de limpieza común, crear un conjunto de funciones que sean útiles/herramienta/script.\n                También se pueden ordenar por frecuencia estimada y atacar los problemas comunes\n                Analizar estadísticas de resumen en cada columna (desviación media estándar, y número de valores perdidos.\n                Realizar registro de operaciones de limpieza con fechas."
            },
            {
                "Pregunta": "6. Explica qué es la regresión logística. ",
                "Respuesta": "Es un método descriptivo basado en la estadística, que se utiliza para revisar un conjunto de datos donde hay una o más variables independientes que van a definir un resultado."
            },
            {
                "Pregunta": "7. Lista algunas de las mejores herramientas que pueden ser útiles para el análisis de datos. ",
                "Respuesta": "RapidMiner, NodeXL\n                Tableau, KNIME,\n                Google Search Operators\n                OpenRefine, Google Fusion Tables,Wolfram Alpha's.\n                Solver."
            },
            {
                "Pregunta": "8. Mencione cuál es la diferencia entre la minería de datos y la elaboración de perfiles de datos. ",
                "Respuesta": "Perfiles de datos: esta centrado en analizar las instancias de atributos individuales. Suministra información sobre distintos atributos como, ocurrencia de valores nulos, valor discreto y su frecuencia, rango de valores tipo de datos, longitud, etc.\n                Minería de datos: Es el análisis de conglomerados, descubrimiento de secuencias, dependencias, detección de registros inusuales, mantenimiento de relaciones entre varios atributos, etc."
            },
            {
                "Pregunta": "9. Enumere algunos problemas comunes a los que se enfrentan los analistas de datos.",
                "Respuesta": ["1. Deficiencia en ortografía común.",
                            "2. Entradas dobles.", 
                            "3. Valores incompletos e ilegales.",
                            "4. Representaciones de valores que cambian.", 
                            "5. Descubrimientos de datos superpuestos."],
                "Type":"arreglo"
            },
            {
                "Pregunta": "10. Mencione el nombre del framework desarrollado por Apache para procesar grandes conjuntos de datos para una aplicación en un entorno de computación distribuido. ",
                "Respuesta": "Framework Hadoop y MapReduce."
            }
        ]
    }
]